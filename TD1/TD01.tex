...
\begin{solution}
 ...
 $11110101100_{2} = 7AC_{16} = 2564_{8}$
...
\item Additionnons un entier $x$ codé en $n$ bits et un entier $y$ codé en $m$
  bits, sur combien de bits faut-il coder le résultat pour éviter un overflow ?
...
\item Même question pour la multiplication avec $n \geq 2$ et $m \geq 2$.
...
Le ratio est donc environ de $4*ln(2)/ln(10)$, soit autour de $1,2$.
